export function createSlider() {
  ...
  // const sliderBack = document.createElement('span');
  const SB = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
  const sliderCurrent = document.createElement('span');
  // const sliderForward = document.createElement('span');
  const SF = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
  
  sliderContainer.classList.add('slider-controll');
  // sliderBack.classList.add('slider_back');
  SB.classList.add('SB');
  SF.classList.add('SF')
  sliderCurrent.classList.add('slider_current');
  // sliderForward.classList.add('slider_forward');

  SB.setAttribute('width', '34');
  SB.setAttribute('height', '18');
  SB.setAttribute("viewBox", "0 0 34 18");
  SB.setAttribute('fill', 'none');
  SB.setAttribute('xmlns', 'http://www.w3.org/2000/svg');

  SF.setAttribute('width', '34');
  SF.setAttribute('height', '18');
  SF.setAttribute("viewBox", "0 0 34 18");
  SF.setAttribute('fill', 'none');
  SF.setAttribute('xmlns', 'http://www.w3.org/2000/svg');
  ...
  SF.appendChild(pathRight);



  // sliderBack.textContent = '';
  sliderCurrent.textContent = '1/4';
  // sliderForward.textContent = '';

  sliderContainer.appendChild(SB);
  sliderContainer.appendChild(sliderCurrent);
  sliderContainer.appendChild(SF);
